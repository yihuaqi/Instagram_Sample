...
import com.example.yihuaqi.instagram_sample.InstagramDialog.OAuthDialogListener;
...
public class InstagramApp {
    ...
    public ArrayList<ImageURL> getImages(){
        ...
        try {
            URL url = new URL(IMAGES_URL + "?access_token=" + mAccessToken);
            HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
            ...
            for(int i = 0; i < jsonArray.length(); i++){
                JSONObject thumbnailJsonObject = jsonArray.getJSONObject(i).getJSONObject("images").getJSONObject("thumbnail");
                String thumbnailUrlString = thumbnailJsonObject.getString("url");
                JSONObject lowimageJsonObject = jsonArray.getJSONObject(i).getJSONObject("images").getJSONObject("low_resolution");
                String lowimageUrlString = lowimageJsonObject.getString("url");
                ...
                Log.d("Instagram","Get URL String:"+imageUrlString);
                result.add(new ImageURL(thumbnailUrlString,lowimageUrlString,imageUrlString));
            }
            return result;
